...
static void JNI_JniCommon_AddRef(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_JniCommon_nativeAddRef(
    ...
    jclass jcaller,
    jlong refCountedPointer) {
  return JNI_JniCommon_AddRef(env, base::android::JavaParamRef<jclass>(env, jcaller),
      refCountedPointer);
}

static void JNI_JniCommon_ReleaseRef(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong refCountedPointer);
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_JniCommon_nativeReleaseRef(
    ...
    jclass jcaller,
    jlong refCountedPointer) {
  return JNI_JniCommon_ReleaseRef(env, base::android::JavaParamRef<jclass>(env, jcaller),
      refCountedPointer);
}

static base::android::ScopedJavaLocalRef<jobject> JNI_JniCommon_AllocateByteBuffer(JNIEnv* env,
...
JNI_GENERATOR_EXPORT jobject Java_org_webrtc_JniCommon_nativeAllocateByteBuffer(
    ...
    jclass jcaller,
    jint size) {
  return JNI_JniCommon_AllocateByteBuffer(env, base::android::JavaParamRef<jclass>(env, jcaller),
      size).Release();
}

static void JNI_JniCommon_FreeByteBuffer(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_JniCommon_nativeFreeByteBuffer(
    ...
    jclass jcaller,
    jobject buffer) {
  return JNI_JniCommon_FreeByteBuffer(env, base::android::JavaParamRef<jclass>(env, jcaller),
