...
JNI_GENERATOR_EXPORT jlong Java_org_webrtc_CallSessionFileRotatingLogSink_nativeAddSink(
    ...
    jint maxFileSize,
    jint severity) {
  return JNI_CallSessionFileRotatingLogSink_AddSink(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, dirPath), maxFileSize, severity);
}
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_CallSessionFileRotatingLogSink_nativeDeleteSink(
    ...
    jclass jcaller,
    jlong sink) {
  return JNI_CallSessionFileRotatingLogSink_DeleteSink(env, base::android::JavaParamRef<jclass>(env,
      jcaller), sink);
}
...
JNI_GENERATOR_EXPORT jbyteArray Java_org_webrtc_CallSessionFileRotatingLogSink_nativeGetLogData(
    ...
    jclass jcaller,
    jstring dirPath) {
  return JNI_CallSessionFileRotatingLogSink_GetLogData(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, dirPath)).Release();
}
