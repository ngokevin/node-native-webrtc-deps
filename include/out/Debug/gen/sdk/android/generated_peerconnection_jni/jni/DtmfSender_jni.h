...
static jboolean JNI_DtmfSender_CanInsertDtmf(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong dtmfSender);
...
JNI_GENERATOR_EXPORT jboolean Java_org_webrtc_DtmfSender_nativeCanInsertDtmf(
    ...
    jclass jcaller,
    jlong dtmfSender) {
  return JNI_DtmfSender_CanInsertDtmf(env, base::android::JavaParamRef<jclass>(env, jcaller),
      dtmfSender);
}

static jboolean JNI_DtmfSender_InsertDtmf(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong dtmfSender,
...
JNI_GENERATOR_EXPORT jboolean Java_org_webrtc_DtmfSender_nativeInsertDtmf(
    ...
    jint duration,
    jint interToneGap) {
  return JNI_DtmfSender_InsertDtmf(env, base::android::JavaParamRef<jclass>(env, jcaller),
      dtmfSender, base::android::JavaParamRef<jstring>(env, tones), duration, interToneGap);
}

static base::android::ScopedJavaLocalRef<jstring> JNI_DtmfSender_Tones(JNIEnv* env, const
...
JNI_GENERATOR_EXPORT jstring Java_org_webrtc_DtmfSender_nativeTones(
    ...
    jclass jcaller,
    jlong dtmfSender) {
  return JNI_DtmfSender_Tones(env, base::android::JavaParamRef<jclass>(env, jcaller),
      dtmfSender).Release();
}

static jint JNI_DtmfSender_Duration(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
    jlong dtmfSender);
...
JNI_GENERATOR_EXPORT jint Java_org_webrtc_DtmfSender_nativeDuration(
    ...
    jclass jcaller,
    jlong dtmfSender) {
  return JNI_DtmfSender_Duration(env, base::android::JavaParamRef<jclass>(env, jcaller),
      dtmfSender);
}

static jint JNI_DtmfSender_InterToneGap(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong dtmfSender);
...
JNI_GENERATOR_EXPORT jint Java_org_webrtc_DtmfSender_nativeInterToneGap(
    ...
    jclass jcaller,
    jlong dtmfSender) {
  return JNI_DtmfSender_InterToneGap(env, base::android::JavaParamRef<jclass>(env, jcaller),
      dtmfSender);
}
