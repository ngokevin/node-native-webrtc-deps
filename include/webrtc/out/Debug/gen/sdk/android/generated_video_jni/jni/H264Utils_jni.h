...
JNI_GENERATOR_EXPORT jboolean Java_org_webrtc_H264Utils_nativeIsSameH264Profile(
    ...
    jobject params1,
    jobject params2) {
  return JNI_H264Utils_IsSameH264Profile(env, base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jobject>(env, params1), base::android::JavaParamRef<jobject>(env,
      params2));
}
