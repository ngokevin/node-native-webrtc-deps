...
static void JNI_VideoTrack_AddSink(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
    jlong track,
    jlong nativeSink);
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_VideoTrack_nativeAddSink(
    ...
    jlong track,
    jlong nativeSink) {
  return JNI_VideoTrack_AddSink(env, base::android::JavaParamRef<jclass>(env, jcaller), track,
      nativeSink);
}

static void JNI_VideoTrack_RemoveSink(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong track,
    jlong nativeSink);
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_VideoTrack_nativeRemoveSink(
    ...
    jlong track,
    jlong nativeSink) {
  return JNI_VideoTrack_RemoveSink(env, base::android::JavaParamRef<jclass>(env, jcaller), track,
      nativeSink);
}

static jlong JNI_VideoTrack_WrapSink(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
...
JNI_GENERATOR_EXPORT jlong Java_org_webrtc_VideoTrack_nativeWrapSink(
    ...
    jclass jcaller,
    jobject sink) {
  return JNI_VideoTrack_WrapSink(env, base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jobject>(env, sink));
}

static void JNI_VideoTrack_FreeSink(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
    jlong sink);
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_VideoTrack_nativeFreeSink(
    ...
    jclass jcaller,
    jlong sink) {
  return JNI_VideoTrack_FreeSink(env, base::android::JavaParamRef<jclass>(env, jcaller), sink);
}
