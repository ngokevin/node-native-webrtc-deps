...
static void JNI_NV21Buffer_CropAndScale(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jint cropX,
    jint cropY,
    jint cropWidth,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_NV21Buffer_nativeCropAndScale(
    ...
    jobject dstV,
    jint dstStrideV) {
  return JNI_NV21Buffer_CropAndScale(env, base::android::JavaParamRef<jclass>(env, jcaller), cropX,
      cropY, cropWidth, cropHeight, scaleWidth, scaleHeight,
      base::android::JavaParamRef<jbyteArray>(env, src), srcWidth, srcHeight,
