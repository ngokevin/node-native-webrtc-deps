...
static void JNI_YuvHelper_CopyPlane(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_YuvHelper_nativeCopyPlane(
    ...
    jint width,
    jint height) {
  return JNI_YuvHelper_CopyPlane(env, base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jobject>(env, src), srcStride,
      base::android::JavaParamRef<jobject>(env, dst), dstStride, width, height);
}

static void JNI_YuvHelper_I420Copy(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_YuvHelper_nativeI420Copy(
    ...
    jint width,
    jint height) {
  return JNI_YuvHelper_I420Copy(env, base::android::JavaParamRef<jclass>(env, jcaller),
...
static void JNI_YuvHelper_I420ToNV12(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    const base::android::JavaParamRef<jobject>& srcY,
    jint srcStrideY,
    const base::android::JavaParamRef<jobject>& srcU,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_YuvHelper_nativeI420ToNV12(
    ...
    jint width,
    jint height) {
  return JNI_YuvHelper_I420ToNV12(env, base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jobject>(env, srcY), srcStrideY,
      base::android::JavaParamRef<jobject>(env, srcU), srcStrideU,
      base::android::JavaParamRef<jobject>(env, srcV), srcStrideV,
      base::android::JavaParamRef<jobject>(env, dstY), dstStrideY,
...
static void JNI_YuvHelper_I420Rotate(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    const base::android::JavaParamRef<jobject>& srcY,
    jint srcStrideY,
    const base::android::JavaParamRef<jobject>& srcU,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_YuvHelper_nativeI420Rotate(
    ...
    jint srcHeight,
    jint rotationMode) {
  return JNI_YuvHelper_I420Rotate(env, base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jobject>(env, srcY), srcStrideY,
      base::android::JavaParamRef<jobject>(env, srcU), srcStrideU,
      base::android::JavaParamRef<jobject>(env, srcV), srcStrideV,
      base::android::JavaParamRef<jobject>(env, dstY), dstStrideY,
