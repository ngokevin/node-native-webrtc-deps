...
static void JNI_AudioTrack_SetVolume(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong track,
    jdouble volume);
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_AudioTrack_nativeSetVolume(
    ...
    jlong track,
    jdouble volume) {
  return JNI_AudioTrack_SetVolume(env, base::android::JavaParamRef<jclass>(env, jcaller), track,
      volume);
}
