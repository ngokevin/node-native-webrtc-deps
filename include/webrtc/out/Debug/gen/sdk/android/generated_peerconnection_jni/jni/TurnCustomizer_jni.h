...
static void JNI_TurnCustomizer_FreeTurnCustomizer(JNIEnv* env, const
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_TurnCustomizer_nativeFreeTurnCustomizer(
    ...
    jclass jcaller,
    jlong turnCustomizer) {
  return JNI_TurnCustomizer_FreeTurnCustomizer(env, base::android::JavaParamRef<jclass>(env,
      jcaller), turnCustomizer);
}
...
static jlong Java_TurnCustomizer_getNativeTurnCustomizer(JNIEnv* env, const
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_INSTANCE>(
          env, org_webrtc_TurnCustomizer_clazz(env),
